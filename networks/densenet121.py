...
model.add(densenet.DenseNet121(include_top = True, pooling = None, weights = 'imagenet'))

# 2nd layer as Dense for 38-class classification
...
# early stopping
es = EarlyStopping(monitor= 'val_accuracy', min_delta= 0.0001, patience= 10, verbose=1) #0.001
